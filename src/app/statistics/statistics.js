...
export default class Statistics {
  ...
  render() {
    ...
    this.statistics.addEventListener("click", (event) =>
  ...
  getButtons() {
    let keyValue =
      '<div class="helper"><p>Для сортировки нажмите на заголовок столбца</p></div>';
    this.statistics.insertAdjacentHTML("afterbegin", keyValue);
    keyValue = '<span class="buf"></span>';
    this.statistics.insertAdjacentHTML("afterbegin", keyValue);
    keyValue =
      '<div class="buttons"><a href="#" id="resetButton" class="buttonStatistics">Reset</a> <a href="#" id="repeatButton" class="buttonStatistics">Repeat difficult words</a></div>';
    this.statistics.insertAdjacentHTML("afterbegin", keyValue);
  }
